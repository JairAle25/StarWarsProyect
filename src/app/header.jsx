...
export default function Header(){
    const classNameLinks="text-xl font-bold transition-all duration-200 hover:text-gray-700 md:text-2xl"
    return(
        <header className="h-[10vh] bg-[var(--colorPrincipal)] w-screen flex justify-around items-center sticky">
            ...
            <Link href="/" className="w-[7%] md:w-[15%]"><Image src={starWarsLogoNegro} alt="logo de star wars" className="w-full"/></Link>
